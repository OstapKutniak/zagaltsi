...
export const STATS = {
  ...
  // Накопичення «Болю у спині» (утричі повільніше за перший тюнінг)
  painPerClimbPx: 0.04,   // за кожен px набраної елевації (заліз на вертикальний колайдер)
  painOnHit: 4,           // за одиницю отриманої шкоди
  painRunNoStamina: 4.7,  // /сек біг при нульовій стаміні

  // Накопичення «Тривожності» (утричі повільніше)
  anxietyOnHit: 2.7,      // за одиницю отриманої шкоди
  anxietyPainFull: 1,     // /сек поки «Біль у спині» вщерть — АЛЕ лише до 70%
  anxietyLowHp: 1.3,      // /сек поки ХП < 25%
  anxietyPainCap: 70,     // стеля тривожності від пасивного болю; вище — лише удари при макс. болі
