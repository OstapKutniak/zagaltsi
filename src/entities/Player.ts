...
export class Player extends Actor {
  ...
  update(cmd: InputCommand, time: number, dt: number, surfaceAt: SurfaceAt): void {
    ...
    // TOL = макс. підйом за крок, який гравець долає БЕЗ стрибка. Має покривати найкрутіший
    // крок рампи (≈9px/крок при бігу в глибину), але лишатися НИЖЧЕ повної сходинки-стіни
    // (diff≥2 = ≥64px) — щоб у стіну впиратись, а по рампі плавно йти вгору.
    const TOL = 12;
