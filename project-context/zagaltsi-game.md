...
**Потойбіч (ключова механіка сеттингу):** коли **тривожність сягає 100**, гравець починає **бачити містичну / потойбічну частину України** — світ розкривається своїм фолк-горор-шаром (мітологічні істоти, мани, видіння). Це серце концепту, а не просто «програш». **Поточний ч/б екран (`grayscale` через `postFX`) — лише ПЛЕЙСХОЛДЕР цього видіння**, не фінал; справжній візуальний шар потойбіччя — попереду (TODO).
