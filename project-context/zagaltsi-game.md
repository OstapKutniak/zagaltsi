...
> Гілка розробки: `claude/back-pain-anxiety-system-yk92py`. Канонічна назва проєкту тепер **«Хоругва»** (стара — «Загальці»); URL-репо лишається `zagaltsi`. Концепт-файл `concept.md` (canonical) описує бій, мета-шар, бігунки, ультрапохмурий режим.
